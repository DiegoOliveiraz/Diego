...
<div class="form-actions">
  ...
  <button type="button" class="btn-link" onclick="history.back()">Cancelar</button>
</div>
```
...
<div class="form-group">
  <label for="cep">
    ...
    <button type="button" class="help-icon" data-tooltip="Digite apenas os números do seu CEP">?</button>
  </label>
